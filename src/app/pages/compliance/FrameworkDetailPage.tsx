...
import {
  ArrowLeft, Loader2, ShieldCheck, FlaskConical, FileText,
  AlertTriangle, XCircle, LayoutDashboard, ListChecks, FileBox, Gauge,
} from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-5">
        ...
        <TabsContent value="overview" className="mt-0"><OverviewTab slug={slug!} /></TabsContent>
        <TabsContent value="requirements" className="mt-0"><RequirementsTab slug={slug!} /></TabsContent>
        <TabsContent value="controls" className="mt-0"><ControlsTab slug={slug!} /></TabsContent>
        <TabsContent value="tests" className="mt-0"><TestsTab slug={slug!} /></TabsContent>
        <TabsContent value="policies" className="mt-0"><PoliciesTab slug={slug!} /></TabsContent>
        <TabsContent value="gaps" className="mt-0"><GapsTab slug={slug!} /></TabsContent>
        <TabsContent value="exclusions" className="mt-0"><ExclusionsTab slug={slug!} /></TabsContent>
        <TabsContent value="exports" className="mt-0"><ExportsTab slug={slug!} /></TabsContent>
      </Tabs>
    </PageTemplate>
  );
}
