...
function TemplatesModal({
  ...
  // Track per-template loading/error/done state
  const [creating, setCreating] = useState<string | null>(null);   // templateName being created
  const [cardError, setCardError] = useState<string | null>(null); // error for last attempt
  const [done, setDone] = useState<Set<string>>(new Set());        // templates already created
