...
import {
  ...
  Link as LinkIcon, FlaskConical, BookOpen, PlusCircle, Trash2,
} from 'lucide-react';
import { auditsService, AuditControlRecord, AuditControlStatus } from '@/services/api/audits';
...
export function SectionHead({ icon, title, noMargin }: { icon: React.ReactNode; title: string; noMargin?: boolean }) {
  return (
...
export function FindingRow({ finding, auditId, onDeleted }: { finding: any; auditId: string; onDeleted: () => void }) {
