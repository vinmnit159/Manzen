...
import { type GitHubRepo, type Integration, integrationsService } from '@/services/api/integrations';
...
export interface IntegrationsDataSetters {
  ...
  setCloudflareAccounts: React.Dispatch<React.SetStateAction<CloudflareAccountRecord[]>>;
  setBamboohrAccounts: React.Dispatch<React.SetStateAction<HRIntegrationRecord[]>>;
  setRedashAccounts: React.Dispatch<React.SetStateAction<RedashIntegrationRecord[]>>;
  setWorkspaceAccounts: React.Dispatch<React.SetStateAction<WorkspaceIntegrationRecord[]>>;
  setFleetAccounts: React.Dispatch<React.SetStateAction<FleetIntegrationRecord[]>>;
  setIntercomAccounts: React.Dispatch<React.SetStateAction<IntercomIntegrationRecord[]>>;
  setBigIdAccounts: React.Dispatch<React.SetStateAction<BigIdIntegrationRecord[]>>;
  setPagerdutyAccounts: React.Dispatch<React.SetStateAction<PagerDutyIntegrationRecord[]>>;
  setOpsgenieAccounts: React.Dispatch<React.SetStateAction<OpsgenieIntegrationRecord[]>>;
  setServicenowAccounts: React.Dispatch<React.SetStateAction<ServiceNowIntegrationRecord[]>>;
  setDatadogAccounts: React.Dispatch<React.SetStateAction<DatadogIntegrationRecord[]>>;
  setGcpAccounts: React.Dispatch<React.SetStateAction<GcpIntegrationRecord[]>>;
  setAzureAccounts: React.Dispatch<React.SetStateAction<AzureIntegrationRecord[]>>;
  setWizAccounts: React.Dispatch<React.SetStateAction<WizIntegrationRecord[]>>;
  setLaceworkAccounts: React.Dispatch<React.SetStateAction<LaceworkIntegrationRecord[]>>;
  setSnykAccounts: React.Dispatch<React.SetStateAction<SnykIntegrationRecord[]>>;
  setSonarqubeAccounts: React.Dispatch<React.SetStateAction<SonarQubeIntegrationRecord[]>>;
  setVeracodeAccounts: React.Dispatch<React.SetStateAction<VeracodeIntegrationRecord[]>>;
  setCheckmarxAccounts: React.Dispatch<React.SetStateAction<CheckmarxIntegrationRecord[]>>;
  setVaultAccounts: React.Dispatch<React.SetStateAction<VaultIntegrationRecord[]>>;
  setSecretsManagerAccounts: React.Dispatch<React.SetStateAction<SecretsManagerIntegrationRecord[]>>;
  setCertManagerAccounts: React.Dispatch<React.SetStateAction<CertManagerIntegrationRecord[]>>;
  setOktaAccounts: React.Dispatch<React.SetStateAction<OktaIntegrationRecord[]>>;
  setAzureAdAccounts: React.Dispatch<React.SetStateAction<AzureAdIntegrationRecord[]>>;
  setJumpCloudAccounts: React.Dispatch<React.SetStateAction<JumpCloudIntegrationRecord[]>>;
...
export function useIntegrationsData(): IntegrationsData & IntegrationsDataSetters & { loadStatus: () => Promise<void> } {
