...
export const cloudflareService = {
  ...
  async getTests(accountId: string): Promise<{ success: boolean; data: any[]; seeded: boolean }> {
    return apiClient.get(`/api/integrations/cloudflare/${accountId}/tests`);
  },
};
